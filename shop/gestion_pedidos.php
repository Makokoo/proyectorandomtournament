    ...
    <div class="row">
        ...
        <div class="col col-lg-8 style='float: none;margin-left: auto;margin-right: auto;'">
            ...
            if(verpermiso($_SESSION['nick'],$conexion)>0) {
                ...
                $sql = "SELECT DISTINCT nick FROM clientes JOIN pedidos ON clientes.cod_cliente=pedidos.cod_cliente";
                $r = $conexion->query($sql);
                $te = array();
                ...
                <form action="gestion_pedidos.php" method="post">
                    Seleccione cliente: <select name="cliente" id="cliente">
                        <?php
