...
if(isset($_POST['categoria'])){
    $conexion = conectar();
    $sql = "DELETE FROM categorias WHERE categoria LIKE '".$_POST['categoria']."'";
    $conexion->query($sql);
    echo "Categoria borrada con éxito";
}else {



    $conexion = conectar();
    $sql = "Select categoria from categorias where categorias.categoria not in (select categoria from articulos)";
    ...
    if(count($te)>0) {
        ...
        echo "No hay categorias que se puedan borrar";
    }
}
?>
    </div>
