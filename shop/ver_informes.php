    ...
    <div class="row">
        ...
        <div class="col col-lg-8 style='float: none;margin-left: auto;margin-right: auto;'">
            ...
            <table class="table table-bordered text-center">
                <tr><td>Numero de Clientes</td><td><?=obtenernumeroclientes($conexion)?></td></tr>
                <tr><td>Numero de Pedidos realizados</td><td><?=obtenernumeropedidos($conexion)?></td></tr>
                <tr><td>Numero de Articulos</td><td><?=obtenernumeroarticulos($conexion)?></td></tr>
                <tr><td>Numero de Articulos en alta</td><td><?=obtenerarticulosenalta($conexion)?></td></tr>
                <tr><td>Numero de Articulos en baja</td><td><?=obtenerarticulosenbaja($conexion)?></td></tr>
                <tr><td>Articulos totales vendidos</td><td><?=obtenerarticulosvendidos($conexion);?></td></tr>
            </table>
